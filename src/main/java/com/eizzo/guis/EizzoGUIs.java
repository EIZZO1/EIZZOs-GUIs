...
public class EizzoGUIs extends JavaPlugin {
    ...
    private org.bukkit.NamespacedKey bindingKey;
    ...
    public void onEnable() {
        instance = this;
        this.bindingKey = new org.bukkit.NamespacedKey(this, "menu_id");
        // Initialize Managers
        ...
        getServer().getPluginManager().registerEvents(new com.eizzo.guis.listeners.ItemInteractionListener(this), this);
        // Start Tasks
        ...
        if (getServer().getPluginManager().isPluginEnabled("PlaceholderAPI")) {
            ...
            getLogger().warning("PlaceholderAPI not found - placeholders will not be replaced");
        }
    ...
    public org.bukkit.NamespacedKey getBindingKey() {
        return bindingKey;
    }
